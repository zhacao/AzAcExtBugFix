...
function getAssets (token, next) {
  ...
  request.get({
    url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/variables?api-version=2015-10-31`,
    headers: {
      'Authorization': token
    }
...
function getCredentials (token, next) {
  ...
  request.get({
    url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/credentials?api-version=2015-10-31`,
    headers: {
      'Authorization': token
    }
  }, function (error, response, body) {
...
function createAzureVariable (assetType, assetName, assetValue, assetDescription, token, next) {
  ...
  request.put({
    url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/variables/${assetName}?api-version=2015-10-31`,
    headers: {
      'Authorization': token
    },
    json: {
  ...
  if(azureconfig.dualVars) {
    request.put({
      url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/variables/${assetNameDate}?api-version=${azureconfig.apiVersion}`,
      headers: {
        'Authorization': token
      },
      json: {
...
function createAzureCredential (assetName, assetUserName, assetPassword, assetDescription, token, next) {
  ...
  request.put({
    url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/credentials/${assetNameDate}?api-version=${azureconfig.apiVersion}`,
    headers: {
      'Authorization': token
    },
    json: {
