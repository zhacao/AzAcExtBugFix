...
var getOauthToken = function (next) {
  ...
  request({
    url: `https://login.chinacloudapi.cn/${azureconfig.tenantId}/oauth2/token?api-version=1.0`,
    body: `grant_type=client_credentials&resource=https%3A%2F%2Fmanagement.chinacloudapi.cn%2F&client_id=${encodeURIComponent(azureconfig.clientId)}&client_secret=${encodeURIComponent(clientSecret)}`,
    headers: {
...
var getAutomationAccountRegion = function () {
  return new Promise((resolve) => {
    ...
    getOauthToken(function (token) {
      request.get({
        url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}?api-version=2015-10-31`,
        headers: {
...
var getRunbookInfo = function (runbookName) {
  return new Promise((resolve) => {
    ...
    getOauthToken(function (token) {
      request.get({
        url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/runbooks/${runbookName}?api-version=2015-10-31`,
        headers: {
          'Authorization': token.value,
          'content-type': 'application/json'
        }
...
var getListOfRunbooks = function (next, skip = false, runbookNames = false) {
  ...
  getOauthToken(function (token) {
    request.get({
      url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/runbooks?api-version=2015-10-31${skip}`,
      headers: {
        'Authorization': token.value,
        'content-type': 'application/json'
      }
...
var saveAsDraft = function (next) {
  ...
  getOauthToken(function (token) {
    request.put({
      url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/runbooks/${runbookName}/draft/content?api-version=2015-10-31`,
      headers: {
        'Authorization': token.value,
        'content-type': 'application/json'
      },
...
var createLocalRunbook = function (runbookName, runbookType, existing=false, published=false, next) {
  ...
  if (existing) {
    getOauthToken(function (token) {
      request.get({
        url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/runbooks/${runbookName}/${publishedV}content?api-version=2015-10-31`,
        headers: {
          'Authorization': token.value
        }
      }, function (error, response, body) {
    ...
    getOauthToken(function (token) {
      request.get({
        url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/runbooks/${azureconfig.templateName}/content?api-version=${azureconfig.apiVersion}`,
        headers: {
          'Authorization': token.value
        }
      }, function (error, response, body) {
...
var publishRunbook = function (next) {
  ...
  getOauthToken(function (token) {
    request.post({
      url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/runbooks/${runbookName}/draft/publish?api-version=2015-10-31`,
      headers: {
        'Authorization': token.value
      }
    }, function (error, response, body) {
...
var startPublishedRunbook = function (token, next) {
  ...
  jobs.getHybridWorkerGroups(token, function (hybridWorkers) {
    if (!hybridWorkers) {
      request.put({
        url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/jobs/${guid}?api-version=2017-05-15-preview`,
        headers: {
          'Authorization': token
        },
        json: {
    ...
    .then(function (runOn) {
      if(runOn.detail) {
        request.put({
          url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/jobs/${guid}?api-version=${azureconfig.apiVersion}`,
          headers: {
            'Authorization': token
          },
          json: {
