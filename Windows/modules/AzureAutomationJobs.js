...
function getJobStream(token, guid, jobStreamId, next) {
  ...
  request.get({
    url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/jobs/${guid}/streams/${jobStreamId}?api-version=2017-05-15-preview`,
    headers: {
      'Authorization': token
    }
 ...
 */
 function getJobOutput(token, guid, next) {
  ...
  request.get({
    url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/jobs/${guid}/output?api-version=2017-05-15-preview`,
    headers: {
      'Authorization': token
    }
  }, function (error, response, body) {
...
function getJobStreams(token, guid, next) {
  ...
  request.get({
    url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/jobs/${guid}/streams?api-version=2017-05-15-preview`,
    headers: {
      'Authorization': token
    }
  }, function (error, response, body) {
...
var getHybridWorkerGroups = function (token, next) {
  ...
  request.get({
    url: `https://management.chinacloudapi.cn/subscriptions/${azureconfig.subscriptionId}/resourceGroups/${azureconfig.resourceGroup}/providers/Microsoft.Automation/automationAccounts/${azureconfig.automationAccount}/hybridRunbookWorkerGroups?api-version=2015-10-31`,
    headers: {
      'Authorization': token
    }
  }, function (error, response, body) {
